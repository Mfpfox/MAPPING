...
using stable ID key added for merge (ENSP_ENST_ENSG) to create version of merge ensembl files that contain shared stable IDs, dfs will be used to calculate version ID differences controlling for set of stable IDs.
