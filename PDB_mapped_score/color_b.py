...
# hardcoded min and max based on CADD
...
def color_b(selection='all',item='b',mode='hist',gradient='reversegray',nbins=7,sat=1,value=1,minimum=2,maximum=34,user_rgb='',debug=0):
  """
